const starWarsCharacters = [
 ...
 for(let i=0;i < starWarsCharacters.length;i++) {
    primo.push(starWarsCharacters[i].name);
 }
...
var eyeColor= {
  ...
  /* ESERCIZIO 6
   ...
   mass=Number
    ...
    while (a < starWarsCharacters.length) {
      totaleMassa += parseInt(starWarsCharacters[a].mass);
      a++;
  }
 ...
 switch(true){
    ...
    console.log("ship is under loader");
    break;
 case (totaleMassa=500):
  ...
  */
  ...
  for(let e=0; e<starWarsCharacters.length;e++){
     switch(starWarsCharacters[e].gender){
        case "1":
        gender.robot.push(starWarsCharacters[e])
        break;
     }
